cars = set()
cars = {'ferrari', 'porche', 'bugatti', 'camaro', 'audi', 'ashton martin'}

junkyard = {'porche', 'jeep', 'camaro', 'lexus'}

# see which cars exist in both the cars and the junkyard sets
# print(junkyard.intersection(cars))
# {'camaro', 'porche'}

union_cars_junkyard = junkyard.union(cars)
# print(union_cars_junkyard)
# {'ashton martin', 'bugatti', 'audi', 'ferrari', 'porche', 'lexus', 'jeep', 'camaro'}
# print(union_cars_junkyard.discard("jeep"))
# returns None meaning absence of return value
# print(union_cars_junkyard)
# {'lexus', 'ferrari', 'porche', 'audi', 'bugatti', 'ashton martin', 'camaro'}
...
# Adds model key as values in corresponding make keys
