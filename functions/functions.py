...
def calculate_average(subject, *test_scores, **student_details):
    ...
    print("Type & value of the student_details: ",
          type(student_details), student_details)
    ...
    print(
        f"{student_details['last_name']}, {student_details['first_name']} got an average score of {average_score} in {subject}.")
